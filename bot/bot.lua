...
bot_token = "415341060:AAEBZs5KratadldfXBXCNfATMzUK_eaejfw" --Put You Token Here
send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 284568421
channel_ersali = -1001121944550
gpmod = -1001071908323
require('./bot/methods')
...
function bot_run()
	...
	bot = bot.result
	local runlog = "Bot Name : "..bot.first_name.."\nBot Username : [@"..bot.username.."]\nRun in: "..os.date("%F - %H:%M:%S")
	print(runlog)
...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {284568421},--Sudo users
    info_text = [[|
	|
	|
	]],
...
function load_plugins()
  for k, v in pairs(_config.enabled_plugins) do
    ...
    local ok, err =  pcall(function()
      local t = loadfile("bot/"..v..'.lua')()
      plugins[v] = t
    end)

    if not ok then
      print('\27[31mError loading plugin '..v..'\27[39m')
	  print(tostring(io.popen("lua bot/"..v..".lua"):read('*all')))
